...
//            for(int i=0; i<11; i++)
//            {
//                Product tmp = new Product("2022-12-23", "薪水", 500, "測試用描述", Type.income);
//                tmp.setLoginMethod("local");
//                tmp.setEmail("00957046@email.ntou.edu.tw");
//                tmp.setAccDate("2022-12-23T11:22:51");
//                repository.save(tmp);
//            }
//            Product tmp = new Product("2022-12-22", "早餐", 500, "測試用描述", Type.expense);
//            tmp.setLoginMethod("local");
